...
from optimizations import create_tally, precalculate_tally_and_suffix_array, find_pattern_position_in_first, suffix_array_optimized, fm_search_optimized
...
def test_pattern_position_in_first_col():
    # Test case 1
    text_1 = "banana"
    bwt_1 = "annb$aa"
    pattern_1 = "ana"
    ...
    tally_checkpoint_1 = 3
    tally_1 = create_tally(bwt_1, tally_checkpoint_1)
    first_col_1 = first_column(tots_1)
    expected_result_1 = [2, 3]

    result_1 = find_pattern_position_in_first(bwt_1, pattern_1, first_col_1, tots_1, tally_1, tally_checkpoint_1)
    assert result_1 == expected_result_1, f"Test 1 failed. Expected: {expected_result_1}, Got: {result_1}"
    ...
    tally_checkpoint_2 = 3
    tally_2 = create_tally(bwt_2, tally_checkpoint_2)
    first_col_2 = first_column(tots_2)
    expected_result_2 = [2, 2]

    result_2 = find_pattern_position_in_first(bwt_2, pattern_2, first_col_2, tots_2, tally_2, tally_checkpoint_2)
    assert result_2 == expected_result_2, f"Test 2 failed. Expected: {expected_result_2}, Got: {result_2}"
...
def test_precalculate_tally_and_suffix_array():
    # Test case 1
    text_1 = "banana"
    bwt_1 = "annb$aa"
    tally_checkpoint_1 = 3
    suffix_array_1 = [6, 5, 3, 1, 0, 4, 2]
    suffix_array_checkpoint_1 = 3
    expected_result_tally_1 = {'a': [1, 1, 3], 'n': [0, 2, 2], 'b': [0, 1, 1]}
    expected_result_sa_1 = [6, 1, 2]

    result_tally_1, result_sa_1 = precalculate_tally_and_suffix_array(bwt_1, tally_checkpoint_1, suffix_array_1, suffix_array_checkpoint_1)
    assert result_tally_1 == expected_result_tally_1, f"Test 1 failed. Expected: {expected_result_tally_1}, Got: {result_tally_1}"
    assert result_sa_1 == expected_result_sa_1, f"Test 1 failed. Expected: {expected_result_sa_1}, Got: {result_sa_1}"
    ...
    suffix_array_2 = [11, 10, 7, 4, 1, 0, 9, 8, 6, 3, 5, 2]
    suffix_array_checkpoint_2 = 4
    expected_result_tally_2 = {'i': [1, 1, 3], 'p': [0, 1, 2], 's': [0, 2, 4], 'm': [0, 1, 1]}
    expected_result_sa_2 = [11, 1, 6]

    result_tally_2, result_sa_2 = precalculate_tally_and_suffix_array(bwt_2, tally_checkpoint_2, suffix_array_2, suffix_array_checkpoint_2)
    assert result_tally_2 == expected_result_tally_2, f"Test 2 failed. Expected: {expected_result_tally_2}, Got: {result_tally_2}"
    assert result_sa_2 == expected_result_sa_2, f"Test 2 failed. Expected: {expected_result_sa_2}, Got: {result_sa_2}"
...
def test_fm_search_optimized():
    ...
    suffix_array_opt_1 = suffix_array_optimized(suffix_array_1, suffix_array_checkpoint_1)
    tally_checkpoint_1 = 2
    tally_1 = create_tally(bwt_1, tally_checkpoint_1)
    expected_result_1 = [3, 1]

    result_1 = fm_search_optimized(bwt_1, pattern_1, ranks_1, tots_1, tally_1, tally_checkpoint_1, suffix_array_opt_1, suffix_array_checkpoint_1)
    assert result_1 == expected_result_1, f"Test 1 failed. Expected: {expected_result_1}, Got: {result_1}"
    ...
    suffix_array_opt_2 = suffix_array_optimized(suffix_array_2, suffix_array_checkpoint_2)
    tally_checkpoint_2 = 2
    tally_2 = create_tally(bwt_2, tally_checkpoint_2)
    expected_result_2 = [7]

    result_2 = fm_search_optimized(bwt_2, pattern_2, ranks_2, tots_2, tally_2, tally_checkpoint_2, suffix_array_opt_2, suffix_array_checkpoint_2)
    assert result_2 == expected_result_2, f"Test 2 failed. Expected: {expected_result_2}, Got: {result_2}"

# test_tally_matrix_creation()
# test_pattern_position_in_first_col()
# test_suffix_array_optimized()
# test_precalculate_tally_and_suffix_array()
